...
def process_image(image_path, query):
    try:
        ...
        # ✅ Sử dụng model mới được Groq hỗ trợ
        llama_8b_response = make_api_request("meta-llama/llama-4-scout-17b-16e-instruct")
        llama_70b_response = make_api_request("meta-llama/llama-4-scout-17b-16e-instruct")

        responses = {}
        for model, response in [("llama8b", llama_8b_response), ("llama70b", llama_70b_response)]:
